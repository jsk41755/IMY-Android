...
def wellness_question_data():
    ...
    f = open(wellness_q_output, 'w', encoding='UTF8')
...
def wellness_answer_data():
    ...
    f = open(wellness_a_output, 'w', encoding='UTF8')
    wb = load_workbook(filename=wellness_file)
    ws = wb[wb.sheetnames[0]]
...
def wellness_category_data():
    ...
    f = open(wellness_c_output, 'w', encoding='UTF8')
    wb = load_workbook(filename=wellness_file)
    ws = wb[wb.sheetnames[0]]
...
def wellness_text_classification_data():
    ...
    ques_file = open(wellness_question_file, 'r', encoding='UTF8')
...
def seperate_wellness_data():
    ...
    sperated_file = open(file_path, 'r', encoding='UTF8')
    train_file = open(train_file_path, 'w', encoding='UTF8')
    test_file = open(test_file_path, 'w', encoding='UTF8')
